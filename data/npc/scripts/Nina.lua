...
keywordHandler:addKeyword({'lizard'}, StdModule.say, {npcHandler = npcHandler, text = "The lizards here are the chosen ones of their kind. We believe them to be the strongest warriors in these lands.So I lead my people here to learn their ways. We are mere assassins but they are using foreign techniques and seem to be far more efficient"})
...
keywordHandler:addKeyword({'nina'}, StdModule.say, {npcHandler = npcHandler, text = "I am Nina, leader of the Grey Shadow clan. Me and my followers, the Shadow Nina, are exploring the largely uncharted parts of the continent Zao."})
keywordHandler:addKeyword({'shadow nina'}, StdModule.say, {npcHandler = npcHandler, text = "I am Nina, leader of the Grey Shadow clan. Me and my followers, the Shadow Nina, are exploring the largely uncharted parts of the continent Zao."})
keywordHandler:addKeyword({'grey shadow clan'}, StdModule.say, {npcHandler = npcHandler, text = "I am Nina, leader of the Grey Shadow clan. Me and my followers, the Shadow Nina, are exploring the largely uncharted parts of the continent Zao."})
